		...
		if(exists){
			...
			$(document).ready(function(){
				...
				var replaced = $('#chart_unique_visitors').html().replace(/Unique Visitors/g,'Visitantes Unicos');
				$('#chart_unique_visitors').html(replaced);			
				
				var replaced = $('#chart_page_hits').html().replace(/Page Hits/g,'Visitas');
				$('#chart_page_hits').html(replaced);			
				
				var replaced = $('#chart_bandwidth').html().replace(/Bandwidth/g,'Ancho de Banda');
				$('#chart_bandwidth').html(replaced);			
				
				var replaced = $('#chart_ftp_logins').html().replace(/FTP Logins/g,'Inicios de Sesión FTP');
				$('#chart_ftp_logins').html(replaced);			
